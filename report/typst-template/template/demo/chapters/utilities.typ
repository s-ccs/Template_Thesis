...
When we refer to an abbreviation the first time in the document, the long version will be printed: @eeg. All subsequent references will instead use the short one: @eeg.
